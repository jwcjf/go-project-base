...
// NewAdapterByDBUseTableName creates gorm-adapter by an existing Gorm instance and the specified table prefix
// and table name
// Example: gormadapter.NewAdapterByDBUseTableName(&db, "cms", "casbin") Automatically generate table name like
// this "cms_casbin"
...
func (a *Adapter) createTable() error {
	...
	if !hasIndex {
		if err := a.db.Exec(fmt.Sprintf("CREATE UNIQUE INDEX %s ON %s (p_type,v0,v1,v2,v3,v4,v5)", index, tableName)).
			Error; err != nil {
			return err
		}
	}
